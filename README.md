# `SPRAL_jll.jl` (v2025.1.8+0)

[![deps](https://juliahub.com/docs/SPRAL_jll/deps.svg)](https://juliahub.com/ui/Packages/General/SPRAL_jll/)

This is an autogenerated package constructed using [`BinaryBuilder.jl`](https://github.com/JuliaPackaging/BinaryBuilder.jl).

The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/a9b28744937ada4bee7c111053646fc979854f47/S/SPRAL/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/ralna/spral.git (revision: `c715ad652041cae79311321fba7f2ee1d0b3d478`)
